...
* For APIs that only send public market data, please use the base endpoint **https://data-api.coins.vision**. Please refer to [Market Data Only](./faqs/market_data_only.md) page.
